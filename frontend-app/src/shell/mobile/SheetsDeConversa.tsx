/**
 * Folhas de ação sobre conversas: o menu de uma conversa e o "mover para".
 *
 * Só Mover e Selecionar (decisão D3): renomear e excluir conversa não existem
 * no backend, e um botão que não faz nada é pior que botão nenhum.
 */
...
export function SheetAcoes({ titulo, onMover, onSelecionar, onFechar }: {
  titulo: string;
  onMover: () => void;
  onSelecionar: () => void;
  onFechar: () => void;
